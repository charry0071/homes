				...
				<div class="bgd" style='width:100%'>
					<backdrop>
						<div class="bgdcontent">
							<div class="text">
								<div class="en">WEIYA NETWORK INVESTMENT HOLDINGS LIMITED</div>
        ...
        <div class="lobbtn" @click="toJiaoyi"><i class="iconfont icon-gupiao"></i><i>进入交易大厅</i></div>
			...
			<div class="productcot">
				<div class="product">
					...
					<div class="text">我们最大的资产是我们的员工，薇雅网络国际有限公司只聘用那些富有经验的专业人员，他们已经在金融服务业展示了他们一流的客户服务技巧和领带能力。提供专业的客户服务。我们的销售和营运代表将以专业的中文对客户的任何询问进行解答。</div>
				</div>
				<div class="notice">
					<layout>
						<div slot="left">
