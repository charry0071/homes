...
<script>
	...
	jsStock.JSStock.SetDomain('http://localhost:8989', 'http://localhost:8989')
	jsChart.JSChart.SetDomain('http://localhost:8989', 'http://localhost:8989')
