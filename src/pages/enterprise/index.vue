      ...
      <el-main>
        <div class="fat">
          <div
            class="table-box "
            :style="
              color == 'black-bg' ? 'margin-top: 100px;' : 'margin-top: 200px;'
            "
          >
            <div class="notice">
              ...
              <div v-if="this.currIndexTitle == 1" class="announcement">
                <div
                  class="cont-list"
                ...
                >
                  ...
                  <div class="right">
                    <div
                      :class="currentIndex == index ? 'circleyes' : 'circle'"
                    >
              ...
              <div v-if="this.currIndexTitle == 2" class="announcement">
                <div
                  class="special"
                  v-for="(item, index) in noticeList"
                  :key="index"
                ...
                >
                  <div class="left">
                    <div
                      :class="
                        currentIndex == index ? 'left-dateyes' : 'left-date'
                      "
                    >
                      <div class="left-tian">
                        {{ new Date(item.addTime).getDate() }}
                      </div>
                      <div class="left-data">
                        {{ new Date(item.addTime).getFullYear() }}.{{
                          new Date(item.addTime).getMonth()
                        }}
                      </div>
                    </div>
                    <div class="left-cont">
  ...
  methods: {
    toDetails(item, index) {
      if (this.currIndexTitle == 1) {
        ...
        window.sessionStorage.setItem('newDetail', JSON.stringify(item))
      } else {
        this.$router.push({
    ...
    async handleCurrentChange(page) {
      if (this.currIndexTitle == 1) {
        ...
        // let data = await api.allNewList(opts)
        // if (data.status == 0) {
        //   this.noticeList = data.data.list
        // }
      } else {
    ...
    async getNoticeList() {
      ...
      let { data, meta } = await api.allNewList(query)
