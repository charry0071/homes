      ...
      <div>
        <backdrop1>
          <div class="title-stock"
            ...
            <!-- <span class="stock-title">股票详情</span>
            <span class="stock-title-en">STOCK DETAILS</span> -->
            <span class="stock-title">Chi tiết Chứng khoán</span>
            <span class="stock-title-en">CHI TIẾT CỔ</span>
          </div>
        </backdrop1>
      </div>
      <el-main>
        <div class="fat">
          <div class="table-box "
            ...
            <div class="table-cont-box">
                  ...
                  <el-col :span="8">
                    <div class="test">
                      <!-- <el-input v-model="form.stock"
                                placeholder="请输入股票代码和股票"
                                class="search-public"> -->
                    <el-input v-model="form.stock"
                                 placeholder="Vui lòng nhập mã chứng khoán và chứng khoán"
                                 class="search-public">
                        <!-- <el-button @click="getList" slot="append" icon="iconfont  icon-search"></el-button> -->
                      </el-input>
                      <span @click="getList"
                            class="iconfont icon-search search-stock"></span>
                    </div>
                  </el-col>
                </el-row>
              </div>
              ...
              <table-box :list="list"
                         :getData="getList"
                         :handleOptions="handleOptions"></table-box>
            </div>
          </div>
        </div>
        <newFooter></newFooter>
