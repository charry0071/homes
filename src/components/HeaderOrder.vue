  ...
  <div>
    <div class="header-nav"
      ...
      <div class="header-nav-wrap clearfix"
        ...
        <a @click="toTransform"
           class="nav-left pull-left">
          <!-- <img src="../assets/image/logo-mini.png" alt=""> -->
          <img :src="siteInfo.siteLogoSm"
               alt />
        </a>
        <div class="nav-menu pull-left">
          <el-menu :default-active="activeIndex"
            ...
            <el-menu-item :class="activeIndex === 'home'?'is-active':''"
                          index="home">
                          <!-- 首页 -->
                          Trang đầu
                    </el-menu-item>
            ...
            <el-menu-item index="/transaction?code=603551"
                          style="color:#000; display: flex;align-items: center;">
              <div class="market-data">
                <img src="../assets/image/dp.png"
                     v-if="this.$store.state.systemColor == 'red-bg'"
                     alt />
                <img src="../../static/img/gupiao.png"
                     v-if="this.$store.state.systemColor == 'black-bg'"
                     alt="">
                <span>
                  <!-- 大盘数据 -->
                  Dữ liệu lớn
        ...
        <div class="user pull-right main-col"
          ...
          <el-dropdown trigger="click"
            ...
            <span class="el-dropdown-link"
                  style="color:#fff;line-height: 30px;font-size: 16px;">
                  <!-- 风格 -->
                  Phong cách
                  <i class="el-icon-arrow-down el-icon--right"></i>
            </span>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="black-bg">
                <!-- 深版 -->
                Phiên bản sâu
              </el-dropdown-item>
              <el-dropdown-item command="red-bg">
                <!-- 浅版 -->
                Phiên bản nông
              </el-dropdown-item>
          ...
          <el-dropdown v-if="this.$store.state.haslogin"
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item v-if="!this.$store.state.haslogin"
                                command="c">
                                <!-- 登录 -->
                                 Đăng nhập
                              </el-dropdown-item>
          ...
          <div class=""
            ...
            <a v-if="this.$store.state.haslogin"
               @click="toUserCenter"
               class="user-center">
               <!-- 个人中心 -->
               Trung tâm cá nhân
    ...
    async handleCommand (val) {
      if (val === 'a') {
        ...
        if (data.status === 0) {
          ...
          this.$message.success('Bạn đã đăng xuất!')
